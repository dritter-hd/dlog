...
public class NotEqualsFormula implements ComparisonFormula {
    ...
    public NotEqualsFormula(int left, int right) {
        if (left < 0) {
    ...
    public NotEqualsFormula(int left, ParameterValue<?> right) {
        if (left < 0) {
            throw new IllegalArgumentException("Left component number must not be negative");
        }
        if (right == null) {
    ...
    public NotEqualsFormula(ParameterValue<?> left, int right) {
        if (left == null) {
