...
public class DlogEvaluator implements IEvaluator {
    ...
    private Collection<com.github.dritter.hd.dlog.IFacts> factsNew;
     ...
     */
    @Deprecated
    public Collection<com.github.dritter.hd.dlog.IFacts> _query(String predicateName, int arity) {
     ...
     */
    @Deprecated
    public Collection<com.github.dritter.hd.dlog.IFacts> _query(String predicateName, int arity, String[] params) {

        Collection<com.github.dritter.hd.dlog.IFacts> factsForEvaluation = evaluateRules();
        ...
        Collection<com.github.dritter.hd.dlog.IFacts> result = new ArrayList<com.github.dritter.hd.dlog.IFacts>();

        final Iterator<com.github.dritter.hd.dlog.IFacts> fIt = factsForEvaluation.iterator();

        // Filter result of rule evaluation according to query
        while (fIt.hasNext()) {
            final com.github.dritter.hd.dlog.IFacts f = fIt.next();
     ...
     */
    @Deprecated
    public Collection<com.github.dritter.hd.dlog.IFacts> evaluateNonRecursiveRules() {
        if (null != this.factsNew && this.factsNew.size() > 0) {
     ...
     */
    @Deprecated
    public Collection<com.github.dritter.hd.dlog.IFacts> evaluateRules() {
    ...
    public IFacts query(String predicateName, int arity, String[] params) {
        ...
        Collection<com.github.dritter.hd.dlog.IFacts> result = _query(predicateName, arity, params);

        final Iterator<com.github.dritter.hd.dlog.IFacts> fIt = result.iterator();
    ...
    private void processValues(final List<List<ParameterValue<?>>> values, final com.github.dritter.hd.dlog.IFacts f, String[] params) {
     ...
     */
    @Deprecated
    public List<com.github.dritter.hd.dlog.IFacts> transformFacts(Collection<IFacts> facts) {
        final List<com.github.dritter.hd.dlog.IFacts> fs = new ArrayList<com.github.dritter.hd.dlog.IFacts>(facts.size());
     ...
     */
    @Deprecated
    public void _initalize(final Collection<com.github.dritter.hd.dlog.IFacts> facts, final String rules) {
        this.factsNew = facts;
        this.rules = rules;
    }
     ...
     */
    @Deprecated
    public void _initalize(final Collection<com.github.dritter.hd.dlog.IFacts> facts) {
        this.factsNew = facts;
    }
